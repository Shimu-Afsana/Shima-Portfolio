...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
        ...
        <nav className={`w-full fixed px-5 -mt-10  lg:px-10 
            ...
            <a href="#top">
                <Image src={assets.logo} alt='logo' className='w-58 cursor-pointer mr-5'/>
            </a>
            <ul className={`hidden md:flex items-center gap-6 lg:gap-8 
             rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-30"} `}>
            ...
            px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 '>
